"""Regression checks for the amber-store-cache-trail casebook."""
...
from casebook.harness import assert_expected, amber_store_cache_trail_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_store_cache_trail_summary(), assert_expected())
